	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			...
			<div class="form-group">Client Name:
				<input class="form-control" type="text" name="strClientName" placeholder="Client Name"  value="<?php echo $strClientName ?>" >
			</div>
			<!-- <div class="form-group">Last Name:
				<input class="form-control" type="text" name="txtLastName" placeholder="Last Name"  value="<?php echo $intFirstFloorSF ?>" >
			</div> --!>
			<div class="form-group">Address:
				<input class="form-control" type="text" name="txtAddress" placeholder="Address"  value="<?php echo $strAddress ?>" >
			</div> 
			...
			<div class="form-group">Primary Phone:
				<input class="form-control" type="tel" name="txtPhonePrimary" placeholder="Primary Phone"  value="<?php echo $strPhonePrimary ?>" >
			</div>
			<div class="form-group">Alternative Phone:
				<input class="form-control" type="tel" name="txtPhoneAlternative" placeholder="Alternative Phone"  value="<?php echo $strPhoneAlternative ?>" >
			</div>
			<div class="form-group">Primary Email:
				<input class="form-control" type="text" name="txtEmailPrimary" placeholder="Primary Email"  value="<?php echo $strEmailPrimary ?>" >
			</div>
			<div class="form-group">Alternative Email:
				<input class="form-control" type="text" name="txtEmailAlternative" placeholder="Alternative Email"  value="<?php echo $strEmailAlternative ?>" >
			</div>
...
<input class="form-control" type="number" name="txtAtticSF" value="<?php echo $intAtticSF ?>" placeholder="NOT WORKING - Attic SF" min="0" step="1"  >
</div>
...
<div class='form-group'>Year Built:
			<input class="form-control" type="number" name="txtYearBuilt" value="<?php echo $intTotalSF ?>" placeholder="Year Built" min="1900" step="1"  >
			</div>
